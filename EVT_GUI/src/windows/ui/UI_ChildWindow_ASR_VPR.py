...
class Ui_ChildWindow_ASR_VPR(object):
    def setupUi(self, ChildWindow_ASR_VPR):
        if not ChildWindow_ASR_VPR.objectName():
            ChildWindow_ASR_VPR.setObjectName(u"ChildWindow_ASR_VPR")
        ChildWindow_ASR_VPR.resize(630, 420)
        ChildWindow_ASR_VPR.setMinimumSize(QSize(630, 420))
        self.verticalLayout = QVBoxLayout(ChildWindow_ASR_VPR)
        self.verticalLayout.setSpacing(0)
        self.verticalLayout.setObjectName(u"verticalLayout")
        self.verticalLayout.setContentsMargins(0, 0, 0, 0)
        self.TitleBar = QWidget(ChildWindow_ASR_VPR)
...
"}")
        ...
        self.CentralWidget = QWidget(ChildWindow_ASR_VPR)
...
"}")
        ...
        self.Button_Cancel = QPushButton(ChildWindow_ASR_VPR)
...
"}")
        ...
        self.Button_Save = QPushButton(ChildWindow_ASR_VPR)
...
"}")
        ...
        self.Button_Confirm = QPushButton(ChildWindow_ASR_VPR)
...
"}")
        ...
        self.retranslateUi(ChildWindow_ASR_VPR)

        QMetaObject.connectSlotsByName(ChildWindow_ASR_VPR)
    # setupUi

    def retranslateUi(self, ChildWindow_ASR_VPR):
        ChildWindow_ASR_VPR.setWindowTitle(QCoreApplication.translate("ChildWindow_ASR_VPR", u"Form", None))
        self.Label_Title.setText(QCoreApplication.translate("ChildWindow_ASR_VPR", u"Title", None))
        self.Label_Text.setText(QCoreApplication.translate("ChildWindow_ASR_VPR", u"Text", None))
        self.CheckBox.setText(QCoreApplication.translate("ChildWindow_ASR_VPR", u"CheckBox", None))
        self.Button_Cancel.setText(QCoreApplication.translate("ChildWindow_ASR_VPR", u"PushButton", None))
        self.Button_Save.setText(QCoreApplication.translate("ChildWindow_ASR_VPR", u"PushButton", None))
        self.Button_Confirm.setText(QCoreApplication.translate("ChildWindow_ASR_VPR", u"PushButton", None))